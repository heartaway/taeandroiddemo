...
public class PinterestListView extends PinterestAbsListView {
    ...
    private void setupChild(View child, int position, int y, boolean flowDown, int childrenLeft,
        ...
        if ((recycled && !p.forceAdd) || (p.recycledHeaderFooter &&
                p.viewType == PinterestAdapterView.ITEM_VIEW_TYPE_HEADER_OR_FOOTER)) {
            attachViewToParent(child, flowDown ? -1 : 0, p);
        } else {
            p.forceAdd = false;
            if (p.viewType == PinterestAdapterView.ITEM_VIEW_TYPE_HEADER_OR_FOOTER) {
    ...
    protected View addViewAbove(View theView, int position) {
    ...
    protected View addViewBelow(View theView, int position) {
