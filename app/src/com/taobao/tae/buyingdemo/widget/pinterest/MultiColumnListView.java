...
public class MultiColumnListView extends PinterestListView {
	...
	private int mColumnPaddingLeft = 10;
	private int mColumnPaddingRight = 10;
	...
	private void init(AttributeSet attrs) {
		...
		if( attrs == null ){
			...
			mColumnPaddingLeft = a.getDimensionPixelSize(R.styleable.MultiColumnListView_plaColumnPaddingLeft, getResources().getDimensionPixelSize(R.dimen.pinterest_item_margin_left_and_right));
			mColumnPaddingRight = a.getDimensionPixelSize(R.styleable.MultiColumnListView_plaColumnPaddingRight,  getResources().getDimensionPixelSize(R.dimen.pinterest_item_margin_left_and_right));
			a.recycle();
		}
