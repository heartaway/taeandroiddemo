 ...
 */
public abstract class PinterestAbsListView extends PinterestAdapterView<ListAdapter> implements
ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnTouchModeChangeListener {
    ...
    /**
     * The last scroll state reported to clients through {@link com.taobao.tae.buyingdemo.widget.pinterest.PinterestAbsListView.OnScrollListener}.
     */
    ...
    public interface OnScrollListener {
         ...
         */
        public void onScroll(PinterestAbsListView view, int firstVisibleItem, int visibleItemCount,
                             int totalItemCount);
    }
    ...
    public boolean showContextMenuForChild(View originalView) {
        ...
        if (longPressPosition >= 0) {
            ...
            if (mOnItemLongClickListener != null) {
                handled = mOnItemLongClickListener.onItemLongClick(PinterestAbsListView.this, originalView,
