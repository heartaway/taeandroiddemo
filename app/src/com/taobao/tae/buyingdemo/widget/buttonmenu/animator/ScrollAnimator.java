...
package com.taobao.tae.buyingdemo.widget.buttonmenu.animator;
...
import com.taobao.tae.buyingdemo.widget.pinterest.PinterestAbsListView;
...
public class ScrollAnimator {
	 ...
	 */
	public void setAdditionalScrollListener(PinterestAbsListView.OnScrollListener additionalScrollListener) {
	 ...
	 *
	 * @param refreshableListView to listen.
	 */
	public void configureListView(MultiColumnPullToRefreshListView refreshableListView) {
		this.multiColumnPullToRefreshListView = refreshableListView;
        this.multiColumnPullToRefreshListView.setOnScrollListener(new PinterestAbsListView.OnScrollListener() {
            int scrollPosition;
	 ...
	 */
	public void release() {
        multiColumnPullToRefreshListView.setOnScrollListener(null);
	}
	...
	private void notifyScrollToAdditionalScrollListener(PinterestAbsListView view, int firstVisibleItem, int visibleItemCount,
			int totalItemCount) {
